"""
Mostly copy from https://github.com/hsiangyuzhao/Segmentation-Metrics-PyTorch/blob/master/metric.py
"""
...
class BinaryMetrics:
    ...
    def __call__(self, y_true, y_pred) -> dict[str, torch.Tensor]:
        # origin y_pred shape: (N, H, W, 1)
